...
public class PaymentService {
    ...
    /**
     * Process a direct card payment (for manager-assisted bookings).
     * Charges the customer's card immediately without requiring frontend confirmation.
     *
     * @deprecated Use {@link #processTokenPayment(Reservation, String)} instead for PCI compliance.
     *             This method handles raw card data server-side which requires PCI-DSS Level 1 compliance.
     *
     * @param reservation the reservation to charge for
     * @param cardNumber card number
     * @param expiryMonth expiration month (1-12)
     * @param expiryYear expiration year (e.g., 2025)
     * @param cvc card security code
     * @param cardholderName name on the card
     * @param billingAddressLine1 billing street address
     * @param billingCity billing city
     * @param billingState billing state/province
     * @param billingPostalCode billing postal code
     * @param billingCountry billing country code (e.g., "US")
     * @return payment entity with charge details
     * @throws StripeException if payment fails
     */
    @Deprecated
    @Transactional
    public Payment processDirectCardPayment(
            ...
            String billingCountry) throws StripeException {
        ...
        address.put("line1", billingAddressLine1);
        address.put("city", billingCity);
        address.put("state", billingState);
        address.put("postal_code", billingPostalCode);
        address.put("country", billingCountry);
        ...
        com.stripe.model.PaymentMethod paymentMethod =
            com.stripe.model.PaymentMethod.create(paymentMethodParams);
