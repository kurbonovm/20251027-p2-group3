...
/**
 * Room2 model representing hotel rooms.
...
public class Room2 {
    ...
    public Room2(String id, String hotelId, String roomNumber, String roomType, Double basePrice, 
    ...
    public Room2(String hotelId, String roomNumber, String roomType) {
        this.hotelId = hotelId;
        this.roomNumber = roomNumber;
        this.roomType = roomType;
    }
